  ...
  return (
    <>
      ...
      <div className="numeroWp underline">
          <a
            className="underline"
            href="https://www.instagram.com/espacio_neurocaminos?igsh=MWVlZjNuN3IwNzE0dw=="
          >
            <svg
        ...
        {/* <div className="numeroTel underline">
          <a 
          className="underline"
          href="https://www.instagram.com/espacio_neurocaminos?igsh=MWVlZjNuN3IwNzE0dw=="></a>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
      ...
      <nav>
        ...
        {/* <img
          className="logo"
          src="src/assets/images/cerebro.png"
          alt="centro de salud"
        />
        <img
          className="logoName"
          src="src/assets/images/logoLetraS.png"
          alt=""
        /> */}
        ...
        <ul className={`listaNav${menu ? "isActive" : ""}`}>
          ...
          <li className="underline__blue">
            <a href="#tratamientos">Servicios</a>
          </li>
